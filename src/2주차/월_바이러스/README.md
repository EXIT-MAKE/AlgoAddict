...
| --------- | ----------- | ----- | ----- | --------- | --------- |
| 1 초      | 128 MB      | 74050 | 34493 | 23540     | 45.257%   |

## 문제

신종 바이러스인 웜 바이러스는 네트워크를 통해 전파된다. 한 컴퓨터가 웜 바이러스에 걸리면 그 컴퓨터와 네트워크 상에서 연결되어 있는 모든 컴퓨터는 웜 바이러스에 걸리게 된다. <br /><br />
...
![zmMEZZ8ioN6rhCdHmcIT4a7](https://user-images.githubusercontent.com/55906697/134145654-03381177-0985-4f9c-b509-86bb6a34fe7d.png)
