...
| --------- | ----------- | ----- | ----- | --------- | --------- |
| 1 초      | 128 MB      | 39793 | 13117 | 10435     | 32.595%   |
...
하나 또는 여러줄에 걸쳐서 문자열이 주어진다. 각 문자열은 영문 알파벳, 공백, 소괄호("( )") 대괄호("[ ]")등으로 이루어져 있으며, 길이는 100글자보다 작거나 같다.<br /><br />
...
Help( I[m being held prisoner in a fortune <br />cookie factory)].
([ (([( [ ] ) ( ) (( ))] )) ]).<br />
.<br />
.<br /><br />
